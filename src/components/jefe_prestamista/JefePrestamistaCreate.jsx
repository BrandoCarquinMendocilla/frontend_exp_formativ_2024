...
const FormAddJefePrestamista = () => {
    ...
    const saveProduct = async (e) => {
        ...
        validateCorreo();
        validatePassword();
        if (nameError || apellidoError || direccionError || sedeError || telefonoError || tipoDocumentoError || documentoError || correoError || passwordError
        || !confirmacionPassword || !password) {
            ...
            try {
                ...
                if (validate) {
                    await axios.post("http://localhost:3000/v1/private/save/jefe-prestamista", {
                        name,
                        apellido,
                        direccion,
                        telefono,
        ...
        <div className="container mt-4">
            <div className="card">
                <header className="card-header">
                    <p className="card-header-title">CREAR JEFE DE PRESTAMISTAS</p>
                </header>
...
export default FormAddJefePrestamista;
