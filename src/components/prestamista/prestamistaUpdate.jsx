...
const FormUpdatePrestamista = () => {
    ...
    useEffect(() => {
        const getUserById = async () => {
            try {
                const response = await axios.get(`http://localhost:3000/v1/private/prestamista/${id}`);
                const body = response.data.body
    ...
    const updateJefePrestamista = async (e) => {
        ...
        if (nameError || apellidoError || direccionError  || telefonoError || tipoDocumentoError || documentoError) {
            ...
            try {
                ...
                if (validate) {
                    await axios.patch("http://localhost:3000/v1/private/update/prestamista/" + id, {
                        name,
                        apellido,
                        direccion,
                        telefono,
...
export default FormUpdatePrestamista;
