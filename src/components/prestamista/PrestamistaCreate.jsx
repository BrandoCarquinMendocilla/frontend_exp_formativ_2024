    ...
    const saveProduct = async (e) => {
        ...
        if (nameError || apellidoError || direccionError || telefonoError || tipoDocumentoError || documentoError || correoError || passwordError
            ...
            try {
                ...
                if (validate) {
                    await axios.post("http://localhost:3000/v1/private/save/prestamista", {
                        name,
                        apellido,
                        direccion,
                        telefono,
        ...
        <div className="container mt-4">
            <div className="card">
                <header className="card-header">
                    <p className="card-header-title">CREAR PRESTAMISTAS</p>
                </header>
...
export default FormAddPrestamista;
