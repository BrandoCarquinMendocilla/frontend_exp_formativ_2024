...
const CreateUser = () => {
    ...
    const saveProduct = async (e) => {
        ...
        if (nameError || apellidoError || direccionError || telefonoError || tipoDocumentoError || documentoError || correoError || passwordError
            || !confirmacionPassword || !password || sedeError) {
            ...
            try {
                ...
                if (validate) {
                    await axios.post("http://localhost:3000/v1/create/user", {
                        name,
                        apellido,
                        direccion,
                        telefono,
        ...
        <div className="container mt-4">
            <div className="columns is-centered">
                <div className="column is-half">
                    <div className="card" style={{ width: '1200px' }}> {/* Establece un ancho fijo aquí */}
                        <header className="card-header">
                            <p className="card-header-title">Registrar tu Usuario aqui </p>
                        </header>
